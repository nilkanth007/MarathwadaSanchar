...
<div class="body_wrapper">
	<div class="center">
		...
		<div class="header3">
			...
			<div style="border: 1px solid red; height: auto; margin-top: 3px;">
				<img alt="add1" src="images/208.jpg" />

			</div>
			<div
				style="border: 1px solid red; height: auto; margin-top: 3px; margin-bottom: 3px;">
				<img alt="add2" src="images/207.jpg" />
		...
		<div class="header2">
			<h2 class="title">Participation Gallery</h2>
			<%@include file="Part.html"%>
		</div>
		<div class="footer_top_area">
			<div class="copyright_FFFFtext">
				<p>
